    ...
    return (
      <div className="container-item">
        <div className="candidate-info">
          ...
          <p className="course">{candidate.course}</p>
          <p className="course">{candidate.Cregno}</p>
          <p className="course">{candidate.Cyear}</p>
        </div>
                ...
                this.state.currentVoter.isVerified ? (
                  this.state.currentVoter.hasVoted ? (
                    ...
                    <div className="container-item info">
                      <center>You can now go ahead and cast your vote.</center>
                    </div>
                  )
                ) : (
                  <div className="container-item attention">
                    <center>Please wait for admin to verify you.</center>
                  </div>
                )
              ) : (
                <>
