...
contract Election {
    ...
    function addCandidate(string memory _header, string memory _course, string memory _Cyear, string memory _Cregno)
        public
        // Only admin can add
        onlyAdmin
    {
    ...
    function getAdminReg() public view returns (string memory) {
        return electionDetails.adminReg;
    }
    ...
    function registerAsVoter(string memory _name, string memory _vRegno, string memory _vCourse, string memory _vYear) public {
